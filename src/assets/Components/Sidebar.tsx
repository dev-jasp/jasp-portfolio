        ...
        <aside className="top-0 left-0 h-full w-full px-6 py-4 flex flex-col items-start space-y-6 bg-gradient-to-r lg:items-center lg:fixed lg:w-[600px] xl:w-2/5 xl:px-8 from-gray-900 to-slate-950">
            <div className="lg:text-start">
                ...
                <motion.h1 
                    ...
                    className="text-3xl lg:text-4xl text-gray-100 font-extrabold mt-5 mb-2 tracking-tight font-sans">Jaspher Gargar</motion.h1>
                <motion.p 
                    initial={{x: -100, opacity: 0}}
                    animate= {{x:0, opacity: 1}}
                    transition={{duration: 0.5, delay: 0.9}}
                    className="text-cyan-600 text-lg lg:text-xl mb-4 font-extrabold tracking-tight">Frontend Developer</motion.p>
                <motion.p 
                    initial={{x: -100, opacity: 0}}
                    animate= {{x:0, opacity: 1}}

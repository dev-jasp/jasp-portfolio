   ...
   <div className="py-8 px-6 w-full lg:ml-[600px] lg:w-[calc(100vw-600px)] lg:px-10 lg:items-center xl:ml-[40%] xl:px-16 xl:w-[calc(100vw-40%)] lg:bg-slate-950">
    ...
    <h1 className="flex items-center text-sky-600 text-2xl lg:text-2xl font-bold mb-8">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
        ...
        <p className="text-slate-500 font-medium text-base leading-relaxed">I’m a 23-year-old software developer with a keen interest in exploring emerging technologies to continually expand my skill set.</p>
        <p className="text-slate-500 font-medium text-base leading-relaxed">Everything here is more than just a collection of projects—it's a reflection of my skills, creativity, and dedication as a front-end developer. Every detail has been thoughtfully crafted to demonstrate my expertise in designing intuitive and visually engaging user experiences.</p>
        <p className="text-slate-500 font-medium text-base leading-relaxed">Apart from this, I believe that health is our greatest asset and the best investment we can make in life. That’s why, when I’m not coding, you’ll find me lifting at the <span className="text-slate-300 cursor-pointer">gym</span> as well as travelling and reconnecting with nature to recharge.</p>
        </div>
    <div className="pt-8">
        <h1 className="flex items-center text-sky-600 text-2xl lg:text-2xl font-bold mb-8">
          <span className="mr-2">

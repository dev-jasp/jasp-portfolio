...
function About() {
  ...
  return (
    <div className="ml-[700px] bg-gradient-to-r from-slate-900 to-gray-900 py-12">
       <h1 className="text-indigo-600 text-3xl font-bold mb-12 ">Skills</h1>
       <div>
        <h4 className="text-gray-200 mb-6 font-bold text-xl">Languages</h4>
        </div>
      <div className="flex flex-wrap mb-4">
      <div className="flex flex-col items-center mr-4 mb-4">
        <DiJavascript className="h-14 w-16 text-2xl text-javascript mb-3" />
        <span className="text-blue-500 px-3 py-1.5 text-xs bg-blue-500 bg-opacity-30 font-medium rounded-full cursor-pointer">
          JavaScript
        </span>
      </div>
      <div className="flex flex-col items-center mr-4 mb-4">
       ...
       <div>
        <h4 className="text-gray-200 mb-6 font-bold text-xl">Frameworks</h4>
        </div>
      <div className="flex flex-wrap mb-4">
      <div className="flex flex-col items-center mr-4 mb-4">

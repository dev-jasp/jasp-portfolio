...
const Main = () => {
    return(
      <div className="text-gray-800 text-center p-12 mt-16 font-Poppins">
        ...
        <h3 className="text-xl font-semibold text-pink-700 py-2">Frontend Developer</h3>
      ...
      <div className="mt-24 text-md">
        ...
        <img 
            className="rounded-full my-10 h-52 md:h-auto md:w-48 md:rounded-full md:rounded-s-lg" 
        ...
        <div className="flex flex-col justify-between p-4 tracking-normal md:p-6">
            ...
            <p className="my-8 mx-0 text-sm text-left leading-relaxed text-white">
